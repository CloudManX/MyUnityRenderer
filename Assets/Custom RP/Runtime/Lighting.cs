...
public class Lighting
{
    ...
    void SetupLights(bool useLightsPerObject)
    {
        ...
        if (useLightsPerObject)
        {
            for (; i < indexMap.Length; ++i) // loop through non visible lights
            {
                indexMap[i] = -1;
            }
    ...
    void SetupPointLight (int index, int visibleIndex, ref VisibleLight visibleLight)
    {
        ...
        position.w = 
            1f / Mathf.Max(visibleLight.range * visibleLight.range, 0.0000001f);
    ...
    void SetupSpotLight(int index, int visibleIndex, ref VisibleLight visibleLight)
    {
        ...
        Light light = visibleLight.light;
        float innerCos = Mathf.Cos(Mathf.Deg2Rad * light.innerSpotAngle / 2);
        float outerCos = Mathf.Cos(Mathf.Deg2Rad * visibleLight.spotAngle / 2);
